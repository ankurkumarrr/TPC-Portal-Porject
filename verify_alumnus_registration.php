...
$sql = "SELECT * FROM alumnus where isVerified = 0";
...
<html>
<head>
    <title>Verify Alumnus Registration</title>
        ...
        <tbody>
            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                ...
                <?php 
                    ...
                    ?> 
                <tr onclick=" location.href='verify_alumnus2.php?RollNo=<?php echo $row['RollNo']; ?>' ">
